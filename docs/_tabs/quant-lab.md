...
.ql-list li { padding:0.7rem 0; border-bottom:1px solid var(--border-color, #f4f4f4); }
...
.ql-section { font-size:0.72rem; font-weight:700; letter-spacing:0.06em; text-transform:uppercase; color:var(--text-muted-color, #888); margin:1.5rem 0 0.5rem; padding-bottom:0.4rem; border-bottom:1px solid var(--border-color, #e8e8e8); }
</style>
...
<div class="ql-section">Capstone Project</div>
...
<ul class="ql-list">
  <li>
    ...
    <span class="ql-tech">Python &middot; NumPy &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
  ...
  <li>
    ...
    <span class="ql-tech">Python &middot; NumPy &middot; Plotly &middot; Monte Carlo &middot; Streamlit</span>
  </li>
  <li>
...
<ul class="ql-list">
  <li>
    ...
    <span class="ql-tech">Python &middot; Exchange Rate API &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
    ...
    <span class="ql-tech">Python &middot; yfinance &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
    <a href="{{ "/quant-lab/stock-analysis/" | relative_url }}">Stock Analysis</a>
    <span class="ql-badges"><span class="ql-badge ql-badge-mini">Mini Project</span><span class="ql-badge ql-badge-dash">Dashboard</span></span>
    <span class="ql-desc">SMA, EMA, RSI, MACD, Bollinger Bands</span>
  ...
  <li>
    ...
    <span class="ql-tech">Python &middot; CoinGecko API &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
  ...
  <li>
    <a href="{{ "/quant-lab/london-house-prices/" | relative_url }}">London House Prices</a>
    <span class="ql-badges"><span class="ql-badge ql-badge-mini">Mini Project</span><span class="ql-badge ql-badge-dash">Dashboard</span></span>
    <span class="ql-desc">Choropleth maps, postcode comparison, brand effect &mdash; 10 years of Land Registry data</span>
    <span class="ql-tech">Python &middot; Plotly &middot; GeoPandas &middot; OpenStreetMap &middot; Streamlit</span>
  </li>
</ul>
...
<ul class="ql-list">
  <li>
    ...
    <span class="ql-tech">Python &middot; yfinance &middot; NumPy &middot; SciPy &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
    <a href="{{ "/quant-lab/time-series/" | relative_url }}">Time Series</a>
    <span class="ql-badges"><span class="ql-badge ql-badge-mini">Mini Project</span><span class="ql-badge ql-badge-ml">ML &amp; Quant</span></span>
    <span class="ql-desc">Trend/seasonal/residual decomposition, ACF</span>
    <span class="ql-tech">Python &middot; yfinance &middot; statsmodels &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
    ...
    <span class="ql-tech">Python &middot; VADER &middot; TextBlob &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
    ...
    <span class="ql-tech">Python &middot; yfinance &middot; scikit-learn &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
    ...
    <span class="ql-tech">Python &middot; scikit-learn &middot; NumPy &middot; Plotly &middot; Streamlit</span>
  </li>
  <li>
